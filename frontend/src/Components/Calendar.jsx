        ...
        <div className="grid grid-cols-7 gap-0.5 bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
          ...
          {days.map(day => {
            ...
            return (
              ...
              >
                <div className={`date-number text-right mb-1 ${
                  isToday ? 'font-bold text-white bg-blue-500 rounded-full w-6 h-6 flex items-center justify-center ml-auto' : 'text-gray-700'
                }`}>
                  {day.getDate()}
                </div>
