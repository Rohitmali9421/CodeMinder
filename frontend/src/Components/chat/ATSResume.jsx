...
function ATSResume() {
    ...
    const fetchInternships = async (jobCategory) => {
        ...
        try {
            const { data } = await axios.get(
                `http://localhost:4000/api/intership?category=${jobCategory}`
            );
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const API_KEY = "AIzaSyCnraFmUmkRO-E6o5e71mBygNsq9cCm7nQ"; // Replace with actual API Key
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-100 mt-20 flex items-center justify-center p-6">
